...
```{r, eval=F, echo=F, results='hide', message=FALSE, warning=FALSE}
...
![CiteAs output for http://yt-project.org](yt-project-screenshot.png){width=70%}
...
![CiteAs output for stringr](stringr.png){width=70%}

The provenance chain is illustrated in the API output included at the end of the document, Figure 3, shows the locations and techniques that CiteAs attempted in finding a citation. In this case the system identified DOIs located in the README file; the DOIs relate to both an article and to a zenodo archived version of the software. These DOIs are each are mapped to a citation and a prefered citation displayed to the user.

![CiteAs API data showing origns of CERMINE citation](cermine-prov.png){width=70%}
