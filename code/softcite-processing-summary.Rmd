...
Process summary statistics break down by steps:
...
|Annotations located in PDFs|-|-|1247|-|-|
...
2. The third row is waiting for the update of TEI corpus after the recent update of CSV data.

3. Statistics in the 4th and 5th row are queried from the current version of softcite TEI corpus.
